namespace CMA.core
{
    ...
    /// <summary>
    /// The helper function for converting length units in desired type.
    /// </summary>
    public static class LengthUnitConverter
    {
        ...
        /// </summary>
        /// <param name="value">The internal value to convert.</param>
        ...
        public static double ConvertToMetric(double value, LengthUnitType type, int decimals)
        {
            switch (type)
            {
                ...
                case LengthUnitType.meter:
                    return Math.Round(value * 0.03048, decimals);
